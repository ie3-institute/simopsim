// generated by tscfg 1.1.3 on Wed Nov 27 11:03:41 CET 2024
...
public class SimopsimConfig {
  ...
  public static class Simopsim {
    ...
    public Simopsim(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
  ...
  public SimopsimConfig(com.typesafe.config.Config c) {
    ...
    this.simopsim = c.hasPathOrNull("simopsim") ? new SimopsimConfig.Simopsim(c.getConfig("simopsim"), parentPath + "simopsim.", $tsCfgValidator) : null;
